...
export default function Profile(props) {
    ...
    return (
        <div className="driver-details">
            ...
            <h3 className="mt-2 ml-1 mb-1"><i className="fas fa-home"></i> Address</h3>
            ...
            <div className="mx-auto"><NavLink to="/"><button className="button mt-3" >Back</button></NavLink></div>
            { loading && <div className="form-loader"><Loader /></div> }

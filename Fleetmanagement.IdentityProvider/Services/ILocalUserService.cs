...
namespace Fleetmanagement.IdentityProvider.Services
{
    ...
    { 
        ...
        //Task<UserSecret> GetUserSecret(string subject, string name);

        //Task<bool> UserHasRegisteredTotpSecret(string subject);
    }
}
